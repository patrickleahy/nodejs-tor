...
exports.maxActiveTorsOverlord  = 7; // 5
exports.targetReserveSize      = 3; // 3
exports.maxWipPerTor           = 5;
exports.maxWrapperStrikes      = 3;

exports.verbose               = false;
exports.rootPath              = __dirname;
exports.projectAdminEmail     = 'someEmail@mailinator.com';
exports.smtpTransport         = nodemailer.createTransport("SMTP", {service: "Gmail", auth: {user: "someEmail@gmail.com", pass: "mailSent"}});
